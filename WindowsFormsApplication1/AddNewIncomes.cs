...
{
    public partial class AddNewIncomes : Form
    {
        public AddNewIncomes()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            XElement usr = XElement.Load(@"income.xml");
        ...
        private void AddNewIncomes_Load(object sender, EventArgs e)
        {
            loadCombo();
